...
/*
This was copied straight from the Minecraft decompiled source.
I was kind of just not familiar with the idea of mixins at the time.
Although it's not like now that I know what mixins are anything will be changed,
mixins for this version are a disaster.
 */
...
public class Debug extends Gui
{
    ...
    protected List<String> getDebugInfoRight()
    {
        ...
        else
        {
            ...
            list.add("");
            list.add("2P Utils - Legacy Edition 1.0");
