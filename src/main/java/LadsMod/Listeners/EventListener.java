...
public class EventListener {
	...
	public void scanMessage(ClientChatReceivedEvent event) {
		...
		boolean offCase1 = msg.contains(playerName)&&msg.contains("completed the parkour in ");
		boolean offCase2 = msg.contains("parkour challenge failed!");
		boolean offCase3 = msg.contains("you need to go to the start first!");
		boolean offCase4 = msg.contains("you must not be flying to start the parkour!");

		boolean case1 = msg.contains("you reached checkpoint #");
		boolean case2 = msg.contains("teleported you to checkpoint #");
		boolean case3 = msg.contains("parkour challenge started!");
		boolean case4 = msg.contains("reset your timer to 00:00! get to the finish line!");
		if (case1||case2||case3||case4) {
			KeyInputHandler.ignoreTeleport = true;
		}

		if (offCase1||offCase2||offCase3||offCase4) {
			KeyInputHandler.ignoreTeleport = false;
		}

		if (ConfigManager.copyChat)
			event.setCanceled(ChatCopy.receiveChat(event.message));
	}
